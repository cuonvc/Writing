...
builder.Services.AddSingleton<CommentConverter>();
...
builder.Services.AddSingleton<ResponseObject<CommentDTO>>();
builder.Services.AddSingleton<ResponseObject<List<CommentDTO>>>();
